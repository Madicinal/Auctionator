...
function Atr_Inventory_Show()
	...
	-- No backdrop here on purpose.  The tab's background is Atr_Panel_Inventory, which
	-- spans the whole auction house window and sits below this frame; skinning this
	-- frame as well would draw a 744x374 box on top of that panel.
end
